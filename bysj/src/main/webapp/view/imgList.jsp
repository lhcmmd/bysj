<%@ page contentType="text/html;charset=UTF-8"  pageEncoding="UTF-8" %>
		...
		$(function(){
			 //datagrid添加控件
  			 $("#showImgTable").datagrid({
  			 	url:"${pageContext.request.contextPath}/pro/getProImg?pid="+${param.pid},
  			 	columns:[[
  			 		{title:"复选框",field:"fx",width:1,checkbox:true},
  			 		{title:"图片",field:"picture",width:1,
  			 			formatter:function(value,row,index){
  			 				return "<img width='50' src='${pageContext.request.contextPath}/pro/imgList?url="+ row.product_img + "' />";
  			 			}
  			 		},
  			 		{title:"图片ID",field:"id",width:1},
  			 		{title:"状态",field:"status",width:1},
  			 		{title:"商品ID",field:"pid",width:1},
  			 		{title:"图片路径",field:"product_img",width:2},
  			 		//自定义列显示操作的删除和修改
